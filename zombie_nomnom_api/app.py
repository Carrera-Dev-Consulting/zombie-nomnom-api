...
@click.command()
@click.option("--port", "-p", type=int, default=5000, help="Port number to bind the server to")
@click.option("--host", "-h", type=HostnameParameter(), default="localhost", help="Hostname to bind the server to")
@click.option("--worker-count", "-w", type=int, default=1, help="Number of worker processes to spawn")
